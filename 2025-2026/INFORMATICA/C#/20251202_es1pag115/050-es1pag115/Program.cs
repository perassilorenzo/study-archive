...
namespace _050_es1pag115
{
    internal class Program
    {
        static void Main(string[] args)
        {
            //le informazioni riguardanti gli studenti di una scuola sono caricate in tre vettori paralleli chiamati Cognomi, Nomi e Classi lunghi n. Visualizzare tutti gli studenti che frequentano una clase ricebutra in ingresso
